...
import "../Style/Home.css"; // ← Changed from products.css
import Footer from "./footer";
import Poster from "../Components/poster";

const Home = () => { // ← Changed from ProductsPage
  ...
  return (
    <div className="home-page"> {/* ← Changed from products-page */}
      {/* Header with Filters */}
...
export default Home; // ← Changed from ProductsPage
